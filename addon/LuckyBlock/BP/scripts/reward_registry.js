...
weightedPools.legendary = [
  { weight: 8, kind: "fragments", id: "lb:legendary_fragment", min: 2, max: 4, source: "core" },
  { weight: 6, kind: "entity", id: "lb:rift_burrower_ant", nameTag: "Rift Burrower Ant", source: "slayers_beasts", requiresPostDragon: true },
  ...
  { weight: 12, kind: "item", id: "lb:slasher", source: "slasher_v1", requiresPostDragon: true },
  { weight: 6, kind: "entity", id: "lb:lich", nameTag: "Lich", source: "bosses_of_mass_destruction", requiresPostDragon: true },
  { weight: 8, kind: "item", id: "lb:epic_lucky_block", count: 2, source: "core" },
