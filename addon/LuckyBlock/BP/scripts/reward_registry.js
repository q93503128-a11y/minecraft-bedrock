...
weightedPools.legendary = [
  { weight: 14, kind: "fragments", id: "lb:legendary_fragment", min: 2, max: 4, source: "core" },
  ...
  { weight: 16, kind: "entity", id: "lb:bogre", nameTag: "Bogre", source: "inhabitants", requiresPostDragon: true },
