export const weightedPools = {
  ...
  epic: [
    { weight: 7, kind: "fragments", id: "lb:epic_fragment", min: 2, max: 4, source: "core" },
    { weight: 5, kind: "item", id: "lb:reward_chainsaw", source: "loys_goodies" },
    { weight: 1, kind: "item", id: "lb:reward_golden_hammer", source: "loys_goodies" },
    { weight: 1, kind: "item", id: "lb:reward_pc", source: "loys_goodies" },
    { weight: 4, kind: "item", id: "lb:rare_lucky_block", count: 2, source: "core" },
