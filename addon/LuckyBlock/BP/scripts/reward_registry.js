export const weightedPools = {
  ...
  rare: [
    { weight: 22, kind: "fragments", id: "lb:rare_fragment", min: 2, max: 4, source: "core" },
    { weight: 9, kind: "item", id: "lb:reward_vending_machine", source: "loys_goodies" },
    { weight: 9, kind: "item", id: "lb:reward_pc", source: "loys_goodies" },
    { weight: 8, kind: "item", id: "lb:reward_cctv", source: "loys_goodies" },
    { weight: 8, kind: "item", id: "lb:reward_wrench", source: "loys_goodies" },
    { weight: 7, kind: "item", id: "lb:reward_easel", source: "loys_goodies" },
    { weight: 7, kind: "item", id: "lb:reward_backpack", source: "loys_goodies" },
