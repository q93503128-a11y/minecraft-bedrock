...
| P3 Reward library | 44% | The library now includes a real companion, permanent structure/event family and a dedicated mount, but armor/ranged gear/minigames and sheer outcome count remain thin. |
| P4 Pre-dragon encounters | 55% | Impaler, Irk, Awakened Grove/Ent and War Ant now cover elite + pet + structure/event + mount roles. Ranged encounters, more exploration/miniboss families and additional mount variants remain sparse. |
...
- Overall project against the complete roadmap after 0.16.0: roughly **63–67%**.
...
The largest remaining work is not another boss with more HP. Fishing is now closed; the major remaining work is content breadth: additional pre-dragon encounter variety, armor/ranged rewards and more mount families, additional structures/dungeons/chained events, tier-specific opening presentation, fusion EV/catalyst tuning, and then P8 real-game QA/packaging.
