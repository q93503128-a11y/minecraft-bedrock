...
Baseline reviewed through the 0.27.0 Fortune Gallery milestone.
...
| P3 Reward library | 79% | The library now covers utility/decor, melee, Mythic magic, pet, distinct ground and post-dragon flight mounts, two ranged archetypes, self-defense and exploration/support wearable roles, two mechanically distinct minigames (timed traversal and cooperative projectile accuracy), staged miniboss/exploration and a deployable Auto-Turret family tied to defense gameplay. Additional minigame/wearable variants and sheer outcome count remain thin. |
| P4 Pre-dragon encounters | 81% | Impaler, Irk, Awakened Grove/Ent, War Ant, Nether Wither Spider, Fortune Relay, Fortune Gallery, Royal Anthill/Ant Queen and Fortune Bulwark now cover elite + pet + combat structure + mount + ranged/control + timed traversal + projectile-accuracy co-op + staged miniboss/exploration + deployable-assisted wave-defense roles. Additional independent miniboss/exploration and event variants remain sparse. |
...
- Full content vision from the canon: roughly **67–71%** because the target is hundreds of materially different rewards and broad category coverage.
- Overall project against the complete roadmap after 0.27.0: roughly **81–85%**.
...
The largest remaining work is not another boss with more HP. Fishing, Royal Anthill, deployable defense, two ranged archetypes, ground/flight mounts, two wearable roles and two distinct minigames are now covered; the major remaining work is still content breadth: additional independent pre-dragon encounter families, more wearable/accessory and minigame variants, more late-game encounter combinations, additional structures/dungeons/chained events, and then P8 real-game QA/packaging.
